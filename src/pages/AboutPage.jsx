...
const gridContainerVariants = {
  ...
  visible: {
    opacity: 1,
    transition: {
      staggerChildren: 0.15, // Time delay between each card animating in
    },
  },
};
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <div className="max-w-4xl mx-auto px-4">
              <h2 className="text-3xl font-bold text-center text-gray-800 mb-16">Our Journey & Our Promise</h2>
