      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8"> 
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-sm mb-1">DOT: 2160134</p> [1]
            <p className="text-sm mb-1">MC: 807934</p> [1]
            <p className="text-sm mb-1">Operating Authority: Interstate</p> [1]
            <p className="text-sm mb-3">Fully insured and FMCSA compliant.</p> [1]
            <a 
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/services" className="text-sm hover:text-blue-300 hover:underline transition-colors duration-300">Our Services</Link></li> [1]
              <li><Link to="/about" className="text-sm hover:text-blue-300 hover:underline transition-colors duration-300">About Us</Link></li> [1]
              ...
              <li><Link to="/contact" className="text-sm hover:text-blue-300 hover:underline transition-colors duration-300">Contact Us</Link></li> [1]
              <li><Link to="/privacy-policy" className="text-sm hover:text-blue-300 hover:underline transition-colors duration-300">Privacy Policy</Link></li> [1]
              <li><Link to="/faq" className="text-sm hover:text-blue-300 hover:underline transition-colors duration-300">FAQ</Link></li> {/* Added FAQ Link [1] */}
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 pt-8 text-center">
          <p className="text-sm">&copy; {currentYear} GME Solutions LLC. All rights reserved.</p> [1]
        </div>
      </div>
    </footer>
  );
